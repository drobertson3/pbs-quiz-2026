...
const BADGES = [
  ...
  {id:'nob_master',  emoji:'🏢', name:'Business Fundamentals', desc:'85%+ accuracy over 25+ Nature of Business questions'},
  {id:'bmg_master',  emoji:'🧭', name:'Management Expert',     desc:'85%+ accuracy over 25+ Business Management questions'},
  {id:'bpl_master',  emoji:'🗒️', name:'Planning Pro',          desc:'85%+ accuracy over 25+ Business Planning questions'},
...
function evaluateBadges(student, attempt, totalQuestions){
  ...
  const checks = {
    ...
    nob_master:() => topicAcc('Nature of Business') >= 0.85,
    bmg_master:() => topicAcc('Business Management') >= 0.85,
    bpl_master:() => topicAcc('Business Planning') >= 0.85,
    ...
    all_rounder:() => Object.keys(typeof SYLLABUS !== 'undefined' ? SYLLABUS : {'Nature of Business':1,'Business Management':1,'Business Planning':1})
